...
- Backend: `/Users/coden/.local/bin/claude` version `2.1.220 (Claude Code)`.
...
1. 2026-08-01T12:35Z; cwd `/Users/coden/relay`; resolved executable `/Users/coden/.local/bin/claude`; argv redacted to `claude -p --tools '' --no-session-persistence --safe-mode --strict-mcp-config --setting-sources ''`; prompt transport stdin; exit 1.
