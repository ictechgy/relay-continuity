...
- Backend: `/Users/coden/.local/bin/agy` version `1.1.9`.
...
1. 2026-08-01T12:35Z; cwd `/Users/coden/relay`; resolved executable `/Users/coden/.local/bin/agy`; argv redacted to `agy --sandbox --disable-slash-commands -p`; stdin packet SHA-256 `d04b936dbdafb89a5e78f91c325c043acf591d6337a49e8b5a7fd2308e0f80b1`; exit 2.
2. 2026-08-01T12:35Z; cwd `/Users/coden/relay`; resolved executable `/Users/coden/.local/bin/agy`; argv redacted to `agy --sandbox --disable-slash-commands --print-timeout 5m -p <scoped review prompt>`; exit 1.
